 ...
 */
function createNode(name, description, locationId, public, fqdn, scheme, behindProxy, memory, disk, memoryOverallocate, diskOverallocate, daemonDir, daemonPort, daemonSftpPort, maintenanceMode, uploadSize) {
	const data = makeData(name, description, locationId, public, fqdn, scheme, behindProxy, memory, disk, memoryOverallocate, diskOverallocate, daemonDir, daemonPort, daemonSftpPort, maintenanceMode, uploadSize)
	const Req = new req(process.env.APPLICATION_NODEACTYL_HOST, process.env.APPLICATION_NODEACTYL_KEY)
	return Req.postRequest('CreateNode', data, null)
}

function makeData(name, description, locationId, public, fqdn, scheme, behindProxy, memory, disk, memoryOverallocate, diskOverallocate, daemonDir, daemonPort, daemonSftpPort, maintenanceMode, uploadSize) {
	return {
		'name': name,
