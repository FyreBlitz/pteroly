 ...
 */
function updateBuild(internalId: number, allocation: number, cpu: number, memory: number, disk: number, io: number, swap: number, 
	databases: number, allocations: number, backups: number) {
...
function makeData(internalId: number, allocation: number, cpu: number, memory: number, disk: number, io: number, swap: number, 
	databases: number, allocations: number, backups: number) {
	return {
		"id": internalId,
