...
const getUrl = (request: string, host: string, data: any, _data: any): string => {
	switch (request) {
		...
		case 'GetServerInfo': case 'IsOwner': case 'GetCPU': case 'GetMemory': case 'GetDisk': case 'GetServerName': 
